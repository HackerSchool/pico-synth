...
tusb_desc_device_t const desc_device = {.bLength = sizeof(tusb_desc_device_t),
                                        ...
                                        .bDeviceSubClass = MISC_PROTOCOL_IAD,
...
//--------------------------------------------------------------------+
// Interface Numbers for MIDI and CDC
enum {
    ITF_NUM_CDC = 0,
    ITF_NUM_CDC_DATA,
    ITF_NUM_MIDI,
...
#define CONFIG_TOTAL_LEN                                                       \
    (TUD_CONFIG_DESC_LEN + TUD_MIDI_DESC_LEN + CFG_TUD_CDC * TUD_CDC_DESC_LEN)
